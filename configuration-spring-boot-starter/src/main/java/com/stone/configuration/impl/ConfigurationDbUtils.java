...
public class ConfigurationDbUtils {
	...
	private static final Logger log = LoggerFactory.getLogger(ConfigurationDbUtils.class);
		...
		try {
			...
			if (queryStmt != null) {
				try {
					...
					log.error("Could not close query statement!");
					throw new ConfigurationException(e);
				}
			}
			if (updateStmt != null) {
				try {
					...
					log.error("Could not close update statement!");
					throw new ConfigurationException(e);
				}
			}
			if (insertStmt != null) {
				try {
					...
					log.error("Could not close insert statement!");
					throw new ConfigurationException(e);
				}
			}
			if (connection != null) {
